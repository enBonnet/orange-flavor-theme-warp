...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Generate SVG previews for Warp themes.",
    )
    parser.add_argument(
        "--svg_path",
        type=str,
    ...
    for input_file in sorted(filenames):
        ...
        cell = f"|**[{file_name_to_display(input_file)}](src/{input_file})**|"
        color_dict = get_color_dict(input_dir, input_file)
    ...
    output_str = "\n".join(markdown)
    # Write README.md to the root of the project
